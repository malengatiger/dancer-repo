  ...
  public routes(app: any): void {
    ...
    app
      ...
      .post(async (req: Request, res: Response) => {
        ...
        console.log(msg);
        try {
          const result = await CommuterArrivalLandmarkHelper.addCommuterArrivalLandmark(
      ...
      .post(async (req: Request, res: Response) => {
        ...
        try {
          ...
          Util.sendError(
            res,
            e,
            "findCommuterArrivalLandmarksByLocation failed",
          );
        }
      });
      ...
      .post(async (req: Request, res: Response) => {
        ...
        try {
          ...
          Util.sendError(
            res,
            e,
            "findCommuterArrivalLandmarksByFromLandmark failed",
          );
        }
      });
      ...
      .post(async (req: Request, res: Response) => {
        ...
        try {
          ...
          Util.sendError(
            res,
            e,
            "findCommuterArrivalLandmarksByToLandmark failed",
          );
        }
      });
