...
class CommuterRating extends typegoose_1.Typegoose {
    //
...
], CommuterRating.prototype, "commuterRequestId", void 0);
__decorate([
    typegoose_1.prop({ required: true }),
    __metadata("design:type", rating_1.default)
], CommuterRating.prototype, "rating", void 0);
__decorate([
    typegoose_1.prop({ required: true, trim: true }),
    __metadata("design:type", String)
], CommuterRating.prototype, "userId", void 0);
__decorate([
    typegoose_1.prop({ required: true, default: new Date().toISOString() }),
    __metadata("design:type", String)
], CommuterRating.prototype, "createdAt", void 0);
__decorate([
    typegoose_1.staticMethod,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CommuterRating, "findByUser", null);
__decorate([
    typegoose_1.staticMethod,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], CommuterRating, "findAll", null);
