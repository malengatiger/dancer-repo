...
export class ChatController {
  public routes(app: any): void {
    log(`🏓    ChatController: 💙  setting up messages for live chat ... `);
    /////////

    app
      .route("/getChatMessagesByAssociation")
    ...
    app
      ...
      .post(async (req: Request, res: Response) => {
        ...
        try {
          ...
          const message = await ChatObject.findOne({
            associationID: req.body.associationID,
          });
